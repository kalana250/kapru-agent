...
export default function Home() {
  ...
  return (
    <main className="flex flex-col h-screen bg-boutique">
      <Header />
      ...
      <div className="px-4 pb-6 pt-2">
        ...
        >
          <div className="flex items-center gap-2 bg-white border border-orange-100 rounded-full px-3 py-2 shadow-lg shadow-orange-100/40">
            <button
              type="button"
